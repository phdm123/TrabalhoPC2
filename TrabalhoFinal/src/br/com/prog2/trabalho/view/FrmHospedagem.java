...
import br.com.prog2.trabalho.controller.HospedagemController;
import br.com.prog2.trabalho.negocio.Hospedagem;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					frame.setTitle("Criacao de Hospedagem");
	...
	public FrmHospedagem() {
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, 454, Short.MAX_VALUE))
					.addContainerGap())
		);
		...
		btnExcluir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int i = JOptionPane.showOptionDialog(null, "Deseja excluir esta Hospedagem?", "Exclusao", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[1]);
		...
		btnProcura.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		JButton btnBuscarChale = new JButton("Buscar Chale");
		btnBuscarChale.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				List<Hospedagem> listaHos = new ArrayList();
				HospedagemController controller = new HospedagemController();
